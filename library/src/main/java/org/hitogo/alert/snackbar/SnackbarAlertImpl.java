...
public class SnackbarAlertImpl extends AlertBuilderImpl<SnackbarAlertBuilder, SnackbarAlert> implements SnackbarAlertBuilder {

    public SnackbarAlertImpl(@NonNull Class<? extends AlertImpl> targetClass,
